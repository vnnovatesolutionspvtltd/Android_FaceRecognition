...
public class LoginActivity extends CameraActivity implements ImageReader.OnImageAvailableListener {
...
//  //private static final String TF_OD_API_MODEL_FILE = "facenet_hiroki.tflite";
    ...
    Button register, markattandance;
    String current_date;
...
//        fabswitchcamera = findViewById(R.id.login_switchcam);
        register = findViewById(R.id.btn_registerface);
        ...
        tts = new TextToSpeech(activity, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    Log.d(TAG, "onInit: TextToSpeech failed to start");
                }
            }
        });
        //  markattandance=findViewById(R.id.btn_markattendance);
    ...
    private void showAuthDialog() {
        ...
        final View view = View.inflate(activity, R.layout.auth_dialog, null);
...
//        builder.setMessage("Enter the password");
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (value.equalsIgnoreCase("123456")) {
                    dialog.dismiss();
                    Toast.makeText(activity, "Authorized.", Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                if (jsonArray.length() > 0) {
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        //   pjo.setDate(date);
                        //  UserData pjo1=gson.fromJson(jsonObject1.toString(), UserData.class);
                        //  userDataArrayList.add(pjo1);
                        ...
                        Log.d(TAG, "onPreviewSizeChosen: " + pjo.getExtra());
                        //   rec.setAttendant(0);
            ...
            if (boundingBox != null && goodConfidence) {
                ...
                if (resultsAux.size() > 0) {
                    ...
                    if (conf < 0.70f) {
                        ...
                        confidence = conf;
                        label1 = result.getTitle();
                        if (result.getId().equals("0")) {
                            color = Color.GREEN;
//                            facedetect = true;
                            // Toast.makeText(LoginActivity.activity, "Welcome," +label, Toast.LENGTH_SHORT).show();
...
////                                            faceBmp.compress(Bitmap.CompressFormat.PNG, 100, baos); //bm is the bitmap object
////                                            byte[] b = baos.toByteArray();
////                                            String encoded = Base64.encodeToString(b, Base64.DEFAULT);
////
////
////                                            Map<String, Object> user = new HashMap<>();
////                                            user.put("name", result.getTitle());
////                                            user.put("date",current_date);
////                                            user.put("select_date",true);
////                                        //    user.put("image",encoded);
////                                            db.collection("Attendance_Users")
////                                                    .document()
////                                                    .set(user)
////                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
////                                                        @Override
////                                                        public void onSuccess(Void aVoid) {
////                                                              Toast.makeText(LoginActivity.this, "Your Attendance has been marked.", Toast.LENGTH_SHORT).show();
////                                                            finish();
////                                                        }
////                                                    })
...
//                                            Gson gson = new Gson();
//                                            String recStr = sharedPreferences.getString("Attendance", "[]");
//
...
//                                            recognitionPojo.setCrop(faceBmp);
//                                            recognitionPojo.setName(result.getTitle());
//                                            recognitionPojo.setAttendance_date(current_date);
//                                            recognitionPojo.setCurrent_date(true);
...
//                                });
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        if (label1.equalsIgnoreCase("Unknown")) {
                            txtStatus.setText("Unknown");
                        } else {
                            txtStatus.setText("Hi, " + label1);
                            if (!label1.equalsIgnoreCase(prevLabel))
                                tts.speak(txtStatus.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
                        }
                        prevLabel = label1;
                    }
                });
                ...
                final SimilarityClassifier.Recognition result = new SimilarityClassifier.Recognition(
                        "0", label1, confidence, boundingBox);
...
//    }
    ...
    public void showDialog() {
        ...
        View dialogLayout = inflater.inflate(R.layout.usernamedialog, null);
        TextView name = dialogLayout.findViewById(R.id.username);
        Button button = dialogLayout.findViewById(R.id.submit_btn);
        name.setText("Welcome," + label1);

...
package com.FaceRecognition.tflite;
...
public interface SimilarityClassifier {
  ...
  public class Recognition {
    ...
    public String getAttendant_date() {
      return attendant_date;
    }

    public void setAttendant_date(String attendant_date) {
      this.attendant_date = attendant_date;
    }

    private String attendant_date;
